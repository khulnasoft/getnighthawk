...
Not sure where to start? First, see the [newcomers welcome guide](https://khulnasoft.com/community/newcomers). Grab an open issue with the [help-wanted label](../../labels/help%20wanted) and jump in. Join the [Slack account](http://slack.khulnasoft.com) and engage in conversation. Create a [new issue](/../../issues/new/choose) if needed.  All [pull requests](/../../pulls) should reference an open [issue](/../../issues). Include keywords in your pull request descriptions, as well as commit messages, to [automatically close issues in GitHub](https://help.github.com/en/github/managing-your-work-on-github/closing-issues-using-keywords).
...
# Notes related to Nighthawk [Transform function](https://github.com/khulnasoft/getnighthawk/blob/d13923e181c6bd8daddacee74d8a8d571658d839/pkg/client/transform.go)
1. The format of results generated by Nighthawk is different than format of Fortio's result, to convert Nighthawk's results into Fortio compatible format we use [transform function](https://github.com/khulnasoft/getnighthawk/blob/d13923e181c6bd8daddacee74d8a8d571658d839/pkg/client/transform.go#L17), based on the [proto file](https://github.com/envoyproxy/nighthawk/blob/f42add9bb5c71a5652db2f9471dda357b96d5ee2/api/client/transform/fortio.proto#L31).
